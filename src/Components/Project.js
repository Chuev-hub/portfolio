...
const setting = {
  ...
  console.log(setting)
    return (
        <div className="d-flex justify-content-center align-items-start elementP" style={{marginTop:"50px"}}>
        <ReactPhotoCollage {...setting} style="border:red"/>
        <div className="d-flex justify-content-center flex-column" style={{width:"400px",marginLeft:"30px"}}>
        <div style={{fontSize:"30px"}}>
          ...
          {  d.longMessage}
           ...
           <a href={d.source} target="_blank"><img width="50px" src= {require("../img/icons8-github-120.png")} /></a>
           {d.publishLink.length>0&& <a target="_blank" style={{marginLeft:"10px",marginTop:"2px"}} href={d.publishLink}><img width="40px" src= {require("../img/pngfind.com-hover-icon-png-4333068.png")} /></a>
 } </div>
           </div>
        </div>
